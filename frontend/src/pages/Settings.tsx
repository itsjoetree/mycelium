        ...
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            ...
            <main className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-1">
                    <Card className="flex flex-col items-center p-8 border-primary/30">
                        <div className="w-24 h-24 rounded-full bg-primary/20 flex items-center justify-center border-2 border-primary/50 mb-4">
                            <span className="text-primary font-mono text-3xl uppercase">{session.username[0]}</span>
                        </div>
                ...
                <div className="md:col-span-2 space-y-6">
                    <Card className="p-6 border-glass-surface">
                        <h3 className="mb-4 text-primary uppercase tracking-widest text-xs">Identity Details</h3>
                        <div className="space-y-4">
                            <div>
                                <label className="block text-[0.6rem] uppercase text-text-muted mb-1 font-semibold">Username</label>
                                <div className="bg-bg-deep border border-glass-surface px-4 py-3 rounded-sm text-text-main font-mono">
                                    {session.username}
                                </div>
                            </div>
                            <div>
